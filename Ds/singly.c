   ...
   while(choice!=8)
    {
        ...
        scanf("%d",&choice);
        switch(choice)
        {             case 1:             insatbegin();             break;
          case 2:             insatlast();             break;
            case 3:             insatrandom();             break;
               case 4:             delatfirst();             break;
                  case 5:             delatlast();             break;
                    case 6:            delatrandom();             break;
...
void delatfirst()
{
    ...
    {
        printf("\nList is empty\n");
    }    else  {         ptr = head;         head = ptr->next;
        free(ptr);
        printf("\nNode deleted from the beginning ...\n");
    }
} void delatlast() {     struct node *ptr,*ptr1;
    if(head == NULL)
    {
        printf("\n list is empty");
    }
...
} void delatrandom()
{
   ...
   while (ptr->data!=loc && ptr!=NULL)
    ...
    ptr1 ->next = ptr ->next;         ptr ->next = ptr1;
        free(ptr);
        printf("\nNode deleted");
    }
}
